...
var wprpsp_next_arrow =
  '<span class="slick-next slick-arrow" data-role="none" tabindex="0" role="button"><svg fill="currentColor" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg"><title/><path d="M69.8437,43.3876,33.8422,13.3863a6.0035,6.0035,0,0,0-7.6878,9.223l30.47,25.39-30.47,25.39a6.0035,6.0035,0,0,0,7.6878,9.2231L69.8437,52.6106a6.0091,6.0091,0,0,0,0-9.223Z"/></svg></span>';
var wprpsp_prev_arrow =
  ...
  if (Wppsac.elementor_preview == 0) {
    $(window).on("elementor/frontend/init", function () {
      ...
      $(".wppsac-post-slider-init").each(function (index) {
        ...
        $(this)
          .closest(".elementor-tabs-content-wrapper")
          .addClass("wppsac-elementor-tab-wrap");
  ...
  jQuery(".wppsac-post-slider").each(function (index) {
    ...
    if (Wppsac.is_avada == 1) {
      jQuery(this)
        ...
        .addClass("wppsac-fusion-flex");
    }

    var slider_id = jQuery(this).attr("id");
    var slider_conf = JSON.parse(
      jQuery(this).closest(".wppsac-slick-slider-wrp").attr("data-conf")
    );
...
function wppsac_post_carousel_slider_init() {
  ...
  jQuery(".wppsac-post-carousel").each(function (index) {
    ...
    var carousel_conf = JSON.parse(
      jQuery(this).closest(".wppsac-slick-carousel-wrp").attr("data-conf")
    );
        ...
        responsive: [
          {
            ...
            settings: {
              slidesToShow:
                parseInt(carousel_conf.slides_to_show) > 3
                  ? 3
                  : parseInt(carousel_conf.slides_to_show),
              slidesToScroll: 1,
            },
          },
          {
            ...
            settings: {
              slidesToShow:
                parseInt(carousel_conf.slides_to_show) > 2
                  ? 2
                  : parseInt(carousel_conf.slides_to_show),
              slidesToScroll: 1,
            },
