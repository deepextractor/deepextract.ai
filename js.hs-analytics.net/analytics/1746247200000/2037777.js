 ...
 */
var _hsq = _hsq || [];
_hsq.push(["setPortalId", 2037777]);
_hsq.push(["trackPageView"]);
_hsq.push(["setLegacy", false]);
_hsq.push(["addHashedCookieDomain", "233546881"]);
_hsq.push(["addHashedCookieDomain", "224894981"]);
_hsq.push(["addHashedCookieDomain", "120043735"]);
_hsq.push(["addHashedCookieDomain", "20629287"]);
_hsq.push(["addHashedCookieDomain", "251652889"]);
_hsq.push(["addHashedCookieDomain", "115434009"]);
_hsq.push(["addHashedCookieDomain", "20154023"]);
_hsq.push(["addHashedCookieDomain", "79855176"]);
_hsq.push([
  "embedHubSpotScript",
  "https://js-na1.hs-scripts.com/2037777.js",
  "hs-script-loader",
]);
...
/** _anon_wrapper_ **/ (function () {
  ...
  hstc.utils.resolveInitialUrl = function (t) {
    var e = window.location.origin,
      i = "__hsInitialUrl",
      n =
        window[i] && "string" == typeof window[i] && URL.canParse(window[i], e)
          ? new URL(window[i], e)
          : null,
      r = t && URL.canParse(t, e) ? new URL(t, e) : null;
    if (n && n.search && r) {
  ...
  hstc.tracking.Tracker.prototype.initEventVisualizerScript = function () {
    ...
    try {
      ...
      this.eventBuilderMessageHandler = (t) => {
        ...
        if (hstc.utils.isValidHubUrl(i) || c) {
          const t = e?.message;
          t === s && a();
        }
      };
  ...
  !(function (t) {
    ...
    u = nt.setDocument = function (t) {
      ...
      r.find.CLASS =
        i.getElementsByClassName &&
        function (t, e) {
          if (typeof e.getElementsByClassName !== E && g)
      ...
      var i = 0,
        ...
        c = function (c, h, u, p, g) {
          ...
          if (s && v !== y) {
            ...
            for (; (k = e[d++]); ) k(T, m, h, u);
            if (c) {
              if (y > 0) for (; v--; ) T[v] || m[v] || (m[v] = L.call(p));
              m = mt(m);
            }
            N.apply(p, m);
